...
# 现在可以导入 Django 模型
from wto.models import Country_L,CommercialData_I_Individual

# 读取 Excel 文件
df = pd.read_excel('F:\zyy_wto\data\Commercial_services_import_individual.xlsx')
...
for index, row in df.iterrows():
    ...
    for year_col in year_columns:
        ...
        CommercialData_I_Individual.objects.create(
