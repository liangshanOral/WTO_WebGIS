...
# 现在可以导入 Django 模型
from wto.models import MFN_b, Country_L, ProductSector_MFN

# 读取 Excel 文件
df = pd.read_excel('F:/zyy_wto/data/MFN-by_product_group.xlsx')
...
for index, row in df.iterrows():
    ...
    product_sector, _ = ProductSector_MFN.objects.get_or_create(name=product_sector_name)
