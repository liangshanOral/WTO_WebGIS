...
# 现在可以导入 Django 模型
from wto.models import Country_L,CommercialData_E_Individual

# 读取 Excel 文件
df = pd.read_excel('F:\zyy_wto\data\Commercial_services_export_individual.xlsx')
...
for index, row in df.iterrows():
    ...
    for year_col in year_columns:
        ...
        # export_value_y = row[year_col]  # 如果你也需要导入值

        # 创建或更新 TradeYearData 对象
        CommercialData_E_Individual.objects.create(
