...
# 现在可以导入 Django 模型
from wto.models import TradeYearData_E_Individual, Country, ProductSector

# 读取 Excel 文件
df = pd.read_excel('F:/zyy_wto/data/WtoData_export_Individual.xlsx')
...
for index, row in df.iterrows():
    ...
    for year_col in year_columns:
        ...
        TradeYearData_E_Individual.objects.create(
