...
class TradeData(models.Model):
    ...
    export_value_m = models.DecimalField(max_digits=14, decimal_places=2)
    import_value_ = models.DecimalField(max_digits=14, decimal_places=2)
    export_value = models.DecimalField(max_digits=14, decimal_places=2)
    import_value = models.DecimalField(max_digits=14, decimal_places=2)
    export_value = models.DecimalField(max_digits=14, decimal_places=2)
    import_value = models.DecimalField(max_digits=14, decimal_places=2)
