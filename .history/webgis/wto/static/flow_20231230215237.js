    ...
    var option = {
        ...
        series: [{
            ...
            data: edges.map(edge => ({
                ...
                coords: [ { 
                    name: edge.source,
                    latitude: nodes[edge.source] ? nodes[edge.source].latitude : null,
                    longitude: nodes[edge.source] ? nodes[edge.source].longitude : null
                },
                { 
                    name: edge.target,
                    latitude: nodes[edge.target] ? nodes[edge.target].latitude : null,
                    longitude: nodes[edge.target] ? nodes[edge.target].longitude : null
                }],
                value: edge.value
            })),
            symbolSize: 5,
