    ...
    var option = {
        ...
        series: [{
            ...
            data: edges.map(edge => ({
                ...
                toName: edge.target,
                coords: [
                    { name: edge.source, value: [nodes[edge.source].longitude, nodes[edge.source].latitude, edge.value] },
                    { name: edge.target, value: [nodes[edge.target].longitude, nodes[edge.target].latitude, edge.value] }
                ],
                value: edge.value
            })),
            symbolSize: 5,
