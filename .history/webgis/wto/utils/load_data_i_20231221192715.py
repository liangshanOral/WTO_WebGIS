...
# 现在可以导入 Django 模型
from wto.models import TradeYearIndex_E, Country, ProductSector

# 读取 Excel 文件
df = pd.read_excel('F:/zyy_wto/data/WtoData_export_e.xlsx')
...
for index, row in df.iterrows():
    ...
    for year_col in year_columns:
        ...
        TradeYearIndex_E.objects.create(
            reporting_country=reporting_country,
            year=year,
            emport_value_i=export_value_y,
