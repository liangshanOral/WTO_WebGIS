...
from wto.views import get_country_product_data, get_flow_data ,echarts_data, echarts_flow_data, index
...
urlpatterns = [
    ...
    path('echarts-flow-data/',echarts_flow_data,name="echarts_flow_data"),
